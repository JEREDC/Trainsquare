public class InventoryService : IInventoryService
    {
        ...
        public Paged<InventoryDetails> GetPaginate(int pageIndex, int pageSize)
        {
            ...
            singleRecordMapper: delegate (IDataReader reader, short set)
            {
                ...
                int startingIndex = 0;
                InventoryDetails inventory = MapInventory(reader, ref startingIndex);
        ...
        public Paged<InventoryDetails> GetPaginateSearch(int pageIndex, int pageSize, string query)
        {
            Paged<InventoryDetails> pagedResult = null;
            List<InventoryDetails> result = null;
            int totalCount = 0;

            _data.ExecuteCmd("[dbo].[Inventory_SelectAll_ByQuery]",
        ...
        private InventoryDetails MapInventory(IDataReader reader, ref int startingIndex)
        {
