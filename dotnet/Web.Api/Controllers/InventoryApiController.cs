[Route("api/inventory")]
    ...
    public class InventoryApiController : BaseApiController
    {
        ...
        [HttpGet("paginate")]
        public ActionResult<ItemResponse<Paged<InventoryDetails>>> GetPaginate(int pageIndex, int pageSize)
        {
            int code = 200;
            BaseResponse response = null;
            ...
            try
            {
                Paged<InventoryDetails> page = _service.GetPaginate(pageIndex, pageSize);
        ...
        public ActionResult<ItemResponse<Paged<InventoryDetails>>> GetPaginateSearch(int pageIndex, int pageSize, string query)
        {
            int code = 200;
            BaseResponse response = null;
            ...
            try
            {
                Paged<InventoryDetails> page = _service.GetPaginateSearch(pageIndex, pageSize, query);
