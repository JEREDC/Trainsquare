...
const Workshops = (props) => {
    ...
    //     let workshop = pd.pagedItems;

    //     setFavoriteWorkshops((prevState) => {
    //         let newCurrent = [];
    //         for (let number = 1; number <= pd.totalPages; number++) {
    //             newCurrent.push(
    //                 <Pagination.Item active={number === favoriteWorkshops.currentPage} onClick={onPageClick} key={number}>
    //                     {number}
    //                 </Pagination.Item>
    //             );
    //         }
    //         return { ...prevState, workshop: workshop, lessonsComponents: workshop.map(mapLesson), items: newCurrent };
    //     });
    // };
    ...
    //     setFavoriteWorkshops((prevState) => {
    //         return { ...prevState, pageIndex: newCurrent - 1, currentPage: newCurrent };
    //     });
    // };
    // const onPrevClick = () => {
    //     setUserInput((prevState) => {
    //         let pd = { ...prevState };
    //         pd.currentPage = prevState.currentPage - 1;
    //         pd.pageIndex = prevState.pageIndex - 1;
    //         return pd;
    //     });
    // };
    // const onNextClick = () => {
